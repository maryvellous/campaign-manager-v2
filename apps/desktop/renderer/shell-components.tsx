...
export type IconName = 'note' | 'search' | 'graph' | 'board' | 'live' | 'spark' | 'book' | 'clock' | 'star' | 'settings' | 'folder' | 'plus' | 'back' | 'forward' | 'close' | 'chevron' | 'panel' | 'more' | 'trash' | 'move' | 'rename' | 'refresh';
const paths: Record<IconName, string> = {
  ...
  live: 'M12 5a7 7 0 0 1 7 7 M12 9a3 3 0 0 1 3 3 M12 19a7 7 0 0 1-7-7 M12 15a3 3 0 0 1-3-3 M12 12h.01',
  spark: 'M12 2l2.2 6.3L20 12l-5.8 2.2L12 22l-2.2-7.8L4 12l5.8-3.7z',
